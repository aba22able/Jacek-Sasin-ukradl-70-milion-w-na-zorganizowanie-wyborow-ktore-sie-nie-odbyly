...
class TrelloFacadeTest {
    ...
    {
        //Given
        TrelloCardDto trelloCardDto = new TrelloCardDto("NewCard", "Description", "Top", "3");

        TrelloCard trelloCard = new TrelloCard("NewCard", "Description", "Top", "3");

        CreatedTrelloCardDto createdTrelloCardDto = new CreatedTrelloCardDto("3", "NewCard", "FakeShortURL", new TrelloBadgesDto(3, new TrelloAttachmentsByTypeDto(new TrelloDto(1,2))));
        ...
        //Then
        assertEquals("NewCard", newCard.getName());
        assertEquals("3", newCard.getId());
        assertEquals(1, newCard.getTrelloBadges().getAttachmentsByTypeDto().getTrello().getBoard());
        assertEquals(2, newCard.getTrelloBadges().getAttachmentsByTypeDto().getTrello().getCard());
        assertEquals(3, newCard.getTrelloBadges().getVotes());
    }
}